...
function App() {
  ...
  const VideoEmbed = ({
    src,
    title = "Video",
    className = "vsl-embed w-embed w-iframe w-script",
  }) => (
  ...
  const testimonials = [
    {
      ...
      image: {
        ...
        srcSet:
          "https://cdn.prod.website-files.com/67025756be96d71592e4ec86/6720577b1055a4940102a304_dr.medhat-p-500.jpg 500w, https://cdn.prod.website-files.com/67025756be96d71592e4ec86/6720577b1055a4940102a304_dr.medhat.jpg 750w",
      },
      stats: [
      ...
      videoUrl:
        "https://player.vimeo.com/video/1069179698?badge=0&autopause=0&player_id=0&app_id=58479",
    },
    {
      client: { name: "svenja maltzahn", role: "Entrepreneur" },
      quote:
        "I'm getting so many requests I think I should stop posting videos",
      startingPoint: "Started with 0 Followers",
      image: {
    ...
    },
    {
      ...
      quote:
        "Working with clips agency is so easy, it feels like I have my personal team",
      startingPoint: "Started with 0 Followers",
      image: {
      ...
      videoUrl:
        "https://player.vimeo.com/video/1069179763?badge=0&autopause=0&player_id=0&app_id=58479",
    },
    {
      client: { name: "Rakan", role: "Fitness Coach" },
      quote:
        "I can focus more on my clients because I don't need to think about editing",
      startingPoint: "Started with 0 Followers",
      image: {
    ...
    },
    {
      ...
      quote:
        "Now I can just be myself in front of the camera and they handle everything",
      startingPoint: "Started with 0 Followers",
      image: {
    ...
    },
    {
      ...
      quote:
        "The quality of content they produce is incredible. My engagement went through the roof",
      startingPoint: "Started with 0 Followers",
      image: {
      ...
      <div className="page-wrapper-2">
          ...
          <div className="hero_component">
            <div className="container-new home-marquee">
              <div className="hero-wrapper-4">
                <h1
                  className="hero-heading-2 responsive-heading"
                  style={{
                ...
                <div
                  className="text-large max-width-616px align-center responsive-text"
                  style={{
                ...
                >
                  If you’re a busy creator with no time to edit or post
                  consistently on social media but still recognize the need to
                  grow your brand faster, then this is for you.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container_large">
            <div className="title-wrapper max-width-662px">
              ...
              <div className="text-large center">
                What happens when a branding agency who is obsessed with systems
                and frameworks, decides to dive in the world content creation?
                you get the clips agency.
              </div>
            </div>{" "}
            <div
              style={{
            ...
            >
              <div className="feature-item home">
                ...
                <div className="text-color-grey">
                  In the world of branding, it's a runway. Will you sizzle and
                  steal the show, or will you be lost in the background?
                </div>
              </div>
              <div className="feature-item home">
                <div className="lottie-wrapper">
              ...
              <div className="feature-item home">
                ...
                <div className="text-color-grey">
                  ...
                  creation. Embrace a process that's all about doing more with
                  less fuss.
                </div>
              </div>
            </div>
        ...
        <div id="solutions" className="solution-section">
          <div className="container-new padding-vert-big">
            ...
            <div className="solution-list padding-content-top">
              <Link to="/credits" className="solution-item-link w-inline-block">
                <div className="solutions-item">
                  ...
                  <div className="solution-button">
                    <div className="solution-button-label">
                      Explore Credits™
                    </div>
                  </div>
                </div>
              ...
              <Link
                to="/ghosthost"
                className="solution-item-link w-inline-block"
              >
                <div className="solutions-item">
                  <div className="solution-top">
                    <div className="lottie-icon-wrapper">
              ...
              >
                <div className="solutions-item">
                  <div className="solution-top">
                    ...
                    <div className="text-large-2">
                      Outsource your podcast’s signature editing and
                      distribution
                    </div>
                  </div>
                  <div className="solution-button">
        ...
        <div className="results-section">
          <div className="container-new padding-vert-big padding-no-bottom">
            <div className="title-wrapper max-width-662px">
              <h2 className="section-heading center">Success Stories</h2>
              <div className="max-width-sub-header">
                <div className="text-large center">
                  Clients don’t just love us because we save them time. It’s
                  because we also get them results.
                </div>
              </div>
                    ...
                    <div className="result-content">
                      <div>
                        ...
                        <h3 className="result-heading small">
                          “I love working with this team. I feel so comfortable
                    ...
                    <div className="result-content">
                      <div>
                        ...
                        <h3 className="result-heading small">
                          ...
                          your team I was able to go online and grow my brand”
                        </h3>
                      </div>
                      <div>
                        <div className="text-block-20">
                  ...
                  <div className="result-item">
                    <div className="result-content">
                      <div>
                        ...
                        <h3 className="result-heading small">
                          “What I do with you in 1 hour used to take me a full
                          day on a TV set. I gained so much insights from our
                          sessions ”
                        </h3>
                      </div>
                      <div>
                    ...
                    <div className="result-content">
                      <div>
                        ...
                        <h3 className="result-heading small">
                          ...
                          village to do what you do. Really you have an amazing
                          team”
                        </h3>
                      </div>
                      <div>
        ...
        <div className="section drag hide">
          <div className="container-7 padding-vert-big">
            <div className="title-wrapper max-width-480px">
              <h2 className="section-heading center">50M+ of organic views</h2>
            </div>
        ...
        <div className="cta-section padding-vert-10em">
          ...
          <div
            className="container_large padding-vert-large"
              ...
              <div className="footer-column">
                ...
                <div className="disclaimer-text">
                  ...
                  <span className="text-span-4">
                    ...
                    copyright and trademark laws and are the property of The
                    Clips Agency. Unauthorized use is prohibited.
                  </span>
                </div>
              </div>
              <div className="footer-column">
